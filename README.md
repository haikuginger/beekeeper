[![Build Status](https://travis-ci.org/haikuginger/beekeeper.svg?branch=master)](https://travis-ci.org/haikuginger/beekeeper)
...
## Requirements
beekeeper requires Python 2.7.9/3.4.3 or higher and their built-in modules.
